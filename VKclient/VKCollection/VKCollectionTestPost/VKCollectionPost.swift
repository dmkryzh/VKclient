...
class VKCollectionPost: UITableViewCell {
    ...
    let postTextAndImage: VKCollectionPostSubview = {
        let view = VKCollectionPostSubview()
        return view
    }()
